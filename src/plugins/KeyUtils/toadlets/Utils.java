...
public class Utils {
    static HTMLNode makeDonateFooter(PluginL10n intl) {
        HTMLNode n =
            new HTMLNode(
                "div", "style",
                "text-align: center; margin-top: 1em; border-top: solid 1px #ccc; padding-top: 2em;");

        n.addChild("a", new String[] { "href", "title" },
                   new String[] { KeyUtilsPlugin.PLUGIN_URI + "/About#Donate",
                                  i18n(intl, "Donate.tooltip") }, i18n(intl, "Donate.title"));
