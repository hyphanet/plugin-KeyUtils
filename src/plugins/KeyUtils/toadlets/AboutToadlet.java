...
public class AboutToadlet extends WebInterfaceToadlet {
    ...
    private void makeMainPage(ToadletContext ctx)
            throws ToadletContextClosedException, IOException {
    ...
    private HTMLNode createVersionBox(PluginContext pCtx) {
        ...
        infoContent.addChild("#",
                             "This is KeyUtils " + Version.longVersionString + " (" +
                             Version.version + ')');
    ...
    private HTMLNode createFeatureBox(PluginContext pCtx) {
        InfoboxNode box         =
            pCtx.pageMaker.getInfobox("KeyUtils feature and function summary");
        HTMLNode    infoBox     = box.outer;
        HTMLNode    infoContent = box.content;
    ...
    private HTMLNode createReportBox(PluginContext pCtx) {
        ...
        HTMLNode buglink =
            new HTMLNode("a", "href",
                         "/external-link/?_CHECKED_HTTP_=https://github.com/saces/KeyUtils/issues",
                         "https://github.com/saces/KeyUtils/issues");

        infoContent.addChild(buglink);
        infoContent.addChild("#", ") or report them in sone ");
        infoContent.addChild(new HTMLNode("nobr",
                "@sone://MYLAnId-ZEyXhDGGbYOa1gOtkZZrFNTXjFl1dibLj9E"));
    ...
    private HTMLNode createDonateBox(PluginContext pCtx) {
        ...
        HTMLNode flattrlink =
            flattr.addChild(new HTMLNode("a", "href",
                "/external-link/?_CHECKED_HTTP_=https://flattr.com/thing/374147/KeyUtils"));

        flattrlink.addChild(new HTMLNode("img", new String[] { "src", "align" },
                new String[] { "images/flattr-badge-large.png",
                               "middle" }));
        ...
        btc.addChild(new HTMLNode("img", new String[] { "src", "align" },
                                  new String[] { "images/th_Bitcoinorg_100x35_new.png",
                "middle" }));
