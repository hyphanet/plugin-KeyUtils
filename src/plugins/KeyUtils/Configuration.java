...
public class Configuration {
    ...
    static class HexWidthOption extends ShortCallback {
        ...
        @Override
        public void set(Short val) throws InvalidConfigValueException, NodeNeedRestartException {
            if ( !val.equals(get())) {
                hexWidth = val;
            }
        }
    ...
    static void initialize(SubConfig subconfig) {
        ...
        subconfig.register(OPTION_AUTOMF, false, sortOrder, true, true, "Config.autoMF",
                           "Config.autoMFLong", new AutoMFOption());
        autoMF = subconfig.getBoolean(OPTION_AUTOMF);
        subconfig.register(OPTION_DEEP, false, sortOrder++, true, false, "Config.recursive",
                           "Config.recursiveLong", new DeepOption());
        deep = subconfig.getBoolean(OPTION_DEEP);
        subconfig.register(OPTION_MULTILEVEL, false, sortOrder++, true, false, "Config.multilevel",
                           "Config.multilevelLong", new MultilevelOption());
        deep = subconfig.getBoolean(OPTION_MULTILEVEL);
        subconfig.register(OPTION_HEXWIDTH, (short) 32, sortOrder++, true, false,
                           "Config.hexWidth", "Config.hexWidthLong", new HexWidthOption(), false);
